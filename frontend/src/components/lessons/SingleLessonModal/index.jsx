...
import { formatTime, calculateDuration } from '../../../utils/formatters/index.js';
import { LESSON_TYPES } from '../../../constants/index.js';
import { validateLessonForm } from '../../../utils/validators/index.js';
 ...
 * Modal for creating a new single lesson
 */
function SingleLessonModal({
  ...
  const handleTypeChange = (e) => {
    ...
    const typeConfig = LESSON_TYPES.find((t) => t.value === type);
      ...
      if (participants.length > 0) {
        await Promise.all(
          participants.map((participant) =>
            lessonsApi.addParticipant(lessonId, {
