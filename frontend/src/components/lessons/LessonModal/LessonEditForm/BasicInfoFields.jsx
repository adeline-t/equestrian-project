...
const BasicInfoFields = ({ editFormData, eventData, handleEditChange, handleTypeChange }) => {
  return (
    <>
      {/* Name */}
      ...
      <div className="form-group" style={{ marginBottom: '15px' }}>
        ...
        <select
          name="event_type"
          value={editFormData.event_type || eventData.event_type}
      ...
      <div className="form-group" style={{ marginBottom: '15px' }}>
        ...
        <input
          type="date"
          name="date"
          value={editFormData.date || eventData.date}
          onChange={handleEditChange}
          className="form-input"
          style={{ fontSize: '14px' }}
        />
      ...
      <div className="form-row" style={{ display: 'flex', gap: '10px', marginBottom: '15px' }}>
        <div className="form-group" style={{ flex: 1 }}>
          ...
          <input
            type="time"
            name="start_time"
            value={editFormData.start_time || eventData.start_time}
            onChange={handleEditChange}
            className="form-input"
            style={{ fontSize: '14px' }}
          />
        ...
        <div className="form-group" style={{ flex: 1 }}>
          ...
          <input
            type="time"
            name="end_time"
            value={editFormData.end_time || eventData.end_time}
            onChange={handleEditChange}
            className="form-input"
            style={{ fontSize: '14px' }}
          />
